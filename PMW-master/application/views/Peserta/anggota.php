                ...
                <div class="main-panel">
                    <div class="content">
                        <div class="container-fluid" >
                                <h3 class="mb-30" align="align-items-center">Daftar Anggota</h3>
                            <div class="row">
                                <!-- <div class="col-md-12"> -->
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped mt-3">
                                                ...
                                                <?php foreach($anggota as $key) {?>
                                                    <tr>
                                                        <td><?php echo $key->anggota_nim?></td>
                                                        <td><?php echo $key->anggota_nama?></td>
                                                        <td><?php echo $key->jurusan_nama?></td>
                                                        <td><?php echo $key->prodi_nama?></td>
                                                        <td><?php echo $key->anggota_no_hp?></td>
                                                    </tr>
                                                <?php } ?>
                                                </tbody>
                                            </table>
                                ...
                                <br>
                                <a href="<?php echo site_url()?>Peserta/daftar_proposal"><button type="button" class="btn btn-danger">Kembali</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
